...
const About = () => {
  ...
  return (
    <div id="about" className="mb-10 lg:mb-0">
      ...
      <div className="px-[10%] py-[4%] flex gap-y-8 justify-between items-center flex-col lg:flex-row lg:px-[20%]">
        ...
        <div className="w-full lg:w-1/2 lg:text-left lg:px-[4%] text-center">
          ...
          >
            <>
              <p className=" w-full  text-gray-600 dark:text-gray-400 mb-5 text-lg leading-8">
                Hello! I am Rabiul Ahsan. I live in Barishal, Bangladesh. Right
                now, i am an undergraduate in Computer Science and Engineering
                at UGV. I am a Web Developer. I can build a website by using
                MERNstack technology. Besides it, I learned some tools, which
                makes a website looks more attractive and efficient. Some of my
                projects are given in this portfolio.
              </p>
              <span>
